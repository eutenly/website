        ...
        <div className="features">
            ...
            <div className="feature">
                ...
                <div className="content">
                    ...
                    <p className="ready-to-try">Ready to try it?</p>
            ...
            <div className="feature">
                ...
                <div className="content">
                    ...
                    <p className="ready-to-try highlight">Ready to try it?</p>
                    <a className="invite-button highlight" href="/invite">Invite Eutenly</a>
